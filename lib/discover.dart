          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                GridView.count(
                  shrinkWrap:
                      true, // GridView'i kapsayan en küçük boyuta sığdırır
                  physics:
                      NeverScrollableScrollPhysics(), // GridView içinde kaydırmayı devre dışı bırakır
                  ...
                  children: <Widget>[
                    ...
                    _buildCategoryCard(
                        'Movements', 'assets/post-impressionism.webp'),
                  ],
                ),
              ],
            ),
