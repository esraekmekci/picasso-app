...
class _FilterPageState extends State<FilterPage> {
  ...
  void applyFilters() async {
    ...
    if (widget.category == 'artworks') {
      ...
      // Eğer filtreleme sonucunda hiçbir öğe bulunamadıysa, bir hata mesajı göster
      if (filteredArtworkNames.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('There is no artwork for the selected filters.')),
        );
        return;
      }
    ...
    if (widget.category == 'museums') {
      ...
      // Eğer filtreleme sonucunda hiçbir öğe bulunamadıysa, bir hata mesajı göster
      if (filteredMuseumNames.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('There is no museum for the selected filters.')),
        );
        return;
      }
    ...
    if (widget.category == 'artists') {
      ...
      // Eğer filtreleme sonucunda hiçbir öğe bulunamadıysa, bir hata mesajı göster
      if (filteredArtistNames.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('There is no artists for the selected filters.')),
        );
        return;
      }
    ...
    if (widget.category == 'movements') {
      ...
      // Eğer filtreleme sonucunda hiçbir öğe bulunamadıysa, bir hata mesajı göster
      if (filteredMovementNames.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('There is no movements for the selected filters.')),
        );
        return;
      }
